...
export default class GestorDeBatalla {
    ...
    iniciarNuevaOleada() {
        ...
        if (this.#oleadaActual === 1) {
            console.log("Un titán común se acerca. ¡Es tu oportunidad para demostrar tu valía!");
            ...
            console.log("¡Un Titán Anormal se une a la lucha! Sus movimientos son erráticos.");
            this.#titanes.push(new TitanComun());
            ...
            console.log("¡¡Un estruendo sacude la tierra! ¡¡EL TITÁN ACORAZADO ESTÁ AQUÍ!!");
            this.#titanes.push(new TitanAcorazado());
        }

        else {
            console.log("¡Una oleada masiva! ¡La verdadera batalla por la humanidad comienza!");
            this.#titanes.push(new TitanAcorazado());
            this.#titanes.push(new TitanAnormal());
            this.#titanes.push(new TitanComun());
        }
    ...
    verificarEstadoDelJuego() {
        ...
        const titanesDerrotadosEnEsteTurno = this.#titanes.filter(t => !t.estaVivo() && !t.recompensaOtorgada);
    ...
    getTitanesVivos() { return this.#titanes.filter(t => t.estaVivo()); }
    getEstadoJuego() { return this.#estadoJuego; }
}
